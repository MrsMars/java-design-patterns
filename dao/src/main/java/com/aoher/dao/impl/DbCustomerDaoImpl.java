...
import com.aoher.exception.CustomException;
...
public class DbCustomerDaoImpl implements CustomerDao {
    ...
    private static final Logger log = LoggerFactory.getLogger(DbCustomerDaoImpl.class);

    private final DataSource dataSource;

    /**
     * Creates an instance of {@link DbCustomerDaoImpl} which uses provided <code>dataSource</code>
    ...
    private void mutedClose(Connection connection, PreparedStatement preparedStatement, ResultSet resultSet) {
        try {
            resultSet.close();
